...
## Project Structure
    ...
    ├── new_app_test_dev_22670  # Django project configurations
...
1. Clone this repo and `cd new_app_test_dev_22670`
...
2. Clone this repo and `cd new_app_test_dev_22670`
